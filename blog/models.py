...
class Content(models.Model):
    ...
    image_gallery = models.ManyToManyField(
        'Image', related_name='content_images')
    video_gallery = models.ManyToManyField(
        'Video', related_name='content_videos')
    user_comments = models.ManyToManyField(
        'UserComment', related_name='content_comments', blank=True, default=None)
...
class UserComment(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='blog_user_comments')
